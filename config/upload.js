...
// Create post: optional image + optional video (image → local disk or use image_url; video → S3)
...
const uploadPostMedia = multer({
  ...
  limits: { fileSize: MAX_VIDEO_SIZE }, // 100MB so video fits; image size checked in controller
